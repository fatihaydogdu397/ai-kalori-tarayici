...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<void> _handleRegister() async {
    ...
    try {
      ...
      // Navigate to onboarding, since it's a new registration
              ...
              children: [
                ...
                if (_isLoading)
                  ...
                  ElevatedButton(
                    ...
                    child: Text("Sign Up", style: TextStyle(fontSize: 16.sp, fontWeight: FontWeight.w800)),
                  ),
  ...
  Widget _buildCheckItem(String label, bool isValid, bool isDark) {
    Color color;
    if (isValid) {
      color = isDark ? AppColors.lime : const Color(0xFF10B981); // Emerald green for light mode readability
    } else {
      if (_passController.text.isEmpty && _confirmPassController.text.isEmpty) {
        color = isDark ? Colors.white38 : Colors.black38;
      } else {
        color = AppColors.coral; // Turn red if invalid while typing
      }
    }
